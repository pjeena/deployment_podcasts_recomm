...
def data_loading():
    df_podcasts = pd.read_csv('podcasts.csv')
    df_podcasts_top_10 = pd.read_csv('Top_10_podcasts.csv')
    tfidf_embeddings_matrix = scipy.sparse.load_npz('tfidf_embeddings_matrix.npz')
    ...
    minilm_embeddings_matrix = pickle.load(open('minilm_embeddings_matrix.pkl', 'rb'))
